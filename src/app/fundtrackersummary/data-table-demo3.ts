...
i:any;
 @ViewChild(DataTable) projectsTable;
  ...
  collegename:any;
     ...
     constructor(public ftinfo: FtinfoService,public elem: ElementRef,private router: Router,
...
this.ftinfo.getlinkwithid(id).subscribe(res1 =>{
    this.ft=res1; 
    console.log(id);
              ...
              this.duedate = day+"-"+(monthIndex+1)+"-"+year;
               ...
               for(l in this.assettypes.data)
                ...
                this.remarks= (res.data.json.projects[i].remarks);
                  ...
                  this.totalexp=this.totalexp+Number(this.exp);         
